...
st.markdown("<p style='text-align: center; font-size: 14px;'>Monitoramento Analógico de Segurança - Carga: Etanol (UN 1170) - Vagão: BR-998</p>", unsafe_allow_html=True)
...
            # Mapeamento exato do seu Firebase: 'temperatura atual' com espaço
...
# --- CAIXINHAS DOS SENSORES (USANDO CONCATENAÇÃO SEGURA SEM ERROS DE ASPAS) ---
